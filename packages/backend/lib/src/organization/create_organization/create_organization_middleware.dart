...
class CreateOrganizationMiddleware
    extends Middleware<CreateOrganizationMiddleware> {
  ...
  FutureOr<void> defineVars(HttpRequest req, HttpResponse res) async {
    ...
    homePageUrl = await InputVariableValidator<String>(req, 'homePageUrl',
  ...
  FutureOr<dynamic> run(HttpRequest req, HttpResponse res) async {
    final organizationExists =
        await Organization.byNameAndAdmin(name, userId) != null;
  ...
  @override
  CreateOrganizationMiddleware get newInstance =>
