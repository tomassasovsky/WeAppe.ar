...
class UpdateOrganizationController
    extends Controller<UpdateOrganizationController> {
  ...
  FutureOr<dynamic> run(HttpRequest req, HttpResponse res) async {
    ...
    if (photo != null) {
      final result = await ImgurClient().uploadImage(photo!);
    ...
    if (result.isFailure) {
      ...
      throw AlfredException(500, {
        'message':
            'something went wrong while updating the organization. sorry!',
      });
    }
  ...
  @override
  UpdateOrganizationController get newInstance =>
